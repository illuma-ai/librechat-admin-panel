...
export function TraceDetailPane({ trace, totals, node, isRoot }: TraceDetailPaneProps) {
    ...
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div className="flex shrink-0 items-center justify-between border-b border-(--cui-color-stroke-default) px-3">
        <div className="flex items-center gap-3">
          <span className="border-b-2 border-(--cui-color-stroke-intense) py-2 text-sm font-medium text-(--cui-color-text-default)">
